...
class CRUD:
    ...
    def add_application(self, data):
        self.__db.db_write('INSERT INTO applications (row_id, date_creation, date_change, transport_type, cargo_weight, '
                           ...
                           'phone_number_whatsapp, email, price, currency, tags_payment, status) VALUES (%s, %s, %s, %s, %s, %s, '
                           '%s, %s'
                           ', %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)', data)
    ...
    def add_or_update_application(self, data):
        ...
        if not self.check_already_existed(data[0]):
            self.__db.db_write('INSERT INTO applications (created_at, updated_at, row_id, date_of_loading, date_creation, date_change, transport_type, cargo_weight, '
                               ...
                               'cargo_type, cargo_addition, comment, tags, company_name, company_link, worker_creds, phone_number, '
                               f'phone_number_whatsapp, email, price, currency, tags_payment, processed) VALUES ("{current_time}", "{current_time}", %s, %s, %s, %s, '
                               '%s, %s'
            ...
            self.__db.db_write(
                ...
                'cargo_type = %s, cargo_addition = %s, comment = %s, tags = %s, company_name = %s, company_link = %s, worker_creds = %s, phone_number = %s, '
                f'phone_number_whatsapp = %s, email = %s, price = %s, currency = %s, tags_payment = %s, processed = %s WHERE row_id = {data[0]}', data[1:])
